              ...
              <div class="row">
                <div class="col-md-12 space-y-5">
                  ...
                  <form class="space-y-4" @sumbit.prevent>
                      ...
                      <div class="col-sm-8">
                        <div class="form-group">
                          <a href="#" class="d-block mb-2"
                            >Bukti Pembayaran <input type="checkbox" enabled
                          /></a>
                          <a href="#" class="d-block mb-2"
                            >Surat Pernyataan <input type="checkbox" enabled
                          /></a>
                          <a href="#" class="d-block mb-2"
                          ...
                          /></a>
                          <a href="#" class="d-block mb-2"
                            >Surat Pengantar Perpanjangan STR<input
                              type="checkbox"
                              enabled
                          /></a>
                        </div>
                    ...
                    <div class="row">
                      <!-- <div class="col-md-4"> -->
                      <button type="button" class="col-md-2 btn btn-success">
                        Proses
                      </button>
                      <div class="col-sm-8">
                        <button type="button" class="col-md-2 btn btn-warning">
                          Tolak
                        </button>
                      </div>
                      <!-- </div> -->
